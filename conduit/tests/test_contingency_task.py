...
class ContingencyTaskTest(unittest.TestCase):
    def setUp(self):
        ...
        self.client.user.whoami.return_value = {
            "phid": "PHID-USER-ana",
            "fields": {"username": "ana"},
        }
    ...
    def test_creates_child_in_the_current_users_sprint_workboard(self):
        result = self.create("Resolver incidencia de acceso", "Sprint Ana")
    ...
    def test_missing_backlog_column_aborts_before_a_write(self):
        ...
        result = self.create("Resolver incidencia", "Sprint Ana")
